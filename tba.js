...
module.exports = {
    ...
    getTeams: function(code, callback)
    {
        this.httpGet('/event/' + code + '/teams/keys', callback);
    },

    getMatch: function(match_code, callback)
    {
        this.httpGet('/match/' + match_code, callback);
    },

    getMatches: function(code, callback)
    {
        this.httpGet('/event/' + code + '/matches', callback);
    },

    getOPRs: function(code, callback)
    {
    ...
    getLastMatch: function(code, callback)
    {
    ...
    getNextMatch: function(code, callback)
    {
        this.getMatches(code, function(matches) {
            for (var match in matches) {
    ...
    getTeamStatus: function(code, team_code, callback)
    {
        this.httpGet('/team/' + team_code + '/event/' + code + '/status', callback);
    },

    getTeamLastMatch: function(code, team_code, callback)
    {
        var that = this;
    ...
    getTeamNextMatch: function(code, team_code, callback)
    {
        var that = this;
        that.getTeamStatus(code, team_code, function(status) {
    ...
    getTeamAlliance: function(code, team_code, callback)
    {
    ...
    getTeamRank: function(code, team_code, callback)
    {
        this.getTeamStatus(code, team_code, function(status) {
    ...
    parseMatch: function(complete_match_data)
    {
    ...
    countInArray: function(array, value) {
        return array.reduce((n, x) => n + (x === value), 0);
    },

    genCSV: function(eventCode)
    {
    ...
    genOPRs: function(eventCode, callback)
    {
        var that = this;
        var results = {};
